...
class Railways extends StatefulWidget {
  @override
  _RailwaysState createState() => _RailwaysState();
}

class _RailwaysState extends State<Railways> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: WebView(
          initialUrl: 'https://www.statejob.in/railway-jobs-notification/',
