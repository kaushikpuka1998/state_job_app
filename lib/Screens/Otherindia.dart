...
class OtherIndia extends StatefulWidget {
  @override
  _OtherIndiaState createState() => _OtherIndiaState();
}

class _OtherIndiaState extends State<OtherIndia> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: WebView(
          initialUrl:
              'https://www.statejob.in/all-india-govt-jobs-notification/',
